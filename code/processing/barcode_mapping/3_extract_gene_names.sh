...
# find bbmap path
BBMAP_PATH=$(find $SCRIPT_DIR/../../../ -name "bbmap.sh")

# set path to data
DATA_PATH=$SCRIPT_DIR"/../../../data/extracted_pairs"



# Find data directory
OUT_FOLDER=$SCRIPT_DIR'/../../../data/barcode_map/'
SAM_FILE=$OUT_FOLDER$GROUP'_collapsed.sam'


# Run BB
$BBMAP_PATH ref=$SCRIPT_DIR'/../../../data/metadata/wt_sequences.fasta' path=$OUT_FOLDER
